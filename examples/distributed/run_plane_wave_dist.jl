...
#    BALFEM_SPONGE      sponge width [m]        40
#    BALFEM_MUMAX       sponge strength         5
#    BALFEM_PERIODS     run length in wave periods (if BALFEM_TFINAL unset)  50
# ==============================================================
...
outdir   = genv("BALFEM_OUTDIR", joinpath(ROOT, "output", "plane_wave_dist_$(model_name)"))
