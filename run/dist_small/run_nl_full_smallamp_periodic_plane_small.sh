#!/bin/bash
# SMALL comparison run — nonlinear full-pressure, flat bed, small amplitude A=0.001
#SBATCH --job-name="LFEMcmp_nl_full_smallamp"
...
mpiexecjl -n 4 julia --project=$HOME/GridapLFEM.jl \
    $HOME/GridapLFEM.jl/examples/distributed_small/run_nl_full_smallamp_periodic_plane_small.jl
