#!/bin/bash
# SMALL comparison run — linear, flat bed, big amplitude A=0.1
#SBATCH --job-name="LFEMcmp_lin_bigamp_periodic"
...
mpiexecjl -n 4 julia --project=$HOME/GridapLFEM.jl \
    $HOME/GridapLFEM.jl/examples/distributed_small/run_lin_bigamp_periodic_plane_small.jl
