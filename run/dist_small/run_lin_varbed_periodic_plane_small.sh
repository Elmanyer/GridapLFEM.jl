#!/bin/bash
# SMALL comparison run — linear, variable bed (bar), small amplitude A=0.001
#SBATCH --job-name="LFEMcmp_lin_varbed_periodic"
...
mpiexecjl -n 32 julia --project=$HOME/GridapLFEM.jl \
    $HOME/GridapLFEM.jl/examples/distributed_small/run_lin_varbed_periodic_plane_small.jl
