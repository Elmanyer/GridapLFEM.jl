#!/bin/bash
# SMALL comparison run — nonlinear, no NL-pressure, flat bed, A=0.1
#SBATCH --job-name="LFEMcmp_nl_none_periodic"
...
mpiexecjl -n 32 julia --project=$HOME/GridapLFEM.jl \
    $HOME/GridapLFEM.jl/examples/distributed_small/run_nl_none_periodic_plane_small.jl
