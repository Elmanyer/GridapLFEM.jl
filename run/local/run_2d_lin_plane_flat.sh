#!/bin/bash
# LOCAL small 2-D - lin_plane_flat
#   Baseline. The cluster sibling grew to 44 m pre-fix - first 2-D re-test of the sponge fix.
#   Cluster sibling: run/dist_small/run_lin_periodic_plane_small.sh
